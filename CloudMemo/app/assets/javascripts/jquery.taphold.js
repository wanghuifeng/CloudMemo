...
;(function($)
{
    ...
    var taphold = $.event.special.taphold =
    {
        setup: function(data)
        {
            ...
            $(this).bind("touchstart", data, startHandler)
                   .bind("touchend", stopHandler)
                   .bind("touchmove", leaveHandler);
        },
        teardown: function(namespaces)
        {
            if (!touchSupported) return;
            $(this).unbind("touchstart", startHandler)
                   .unbind("touchend", stopHandler)
                   .unbind("touchmove", leaveHandler);
        }
    };
})(jQuery);
